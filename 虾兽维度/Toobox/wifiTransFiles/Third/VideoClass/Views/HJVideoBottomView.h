...
typedef void(^videoPlayerNextVideoBlock)();
typedef void(^videoPlayerPreVideoBlock)();
...
/** 下一个视频回调*/
@property (nonatomic, copy) videoPlayerNextVideoBlock nextVideoBlock;
/** 上一个视频回调*/
@property (nonatomic, copy) videoPlayerPreVideoBlock preVideoBlock;
/** 是否仅显示slider */
